...
Future<void> initState(BuildContext context) async {
  _streamSubscriptions.add(
    await userAccelerometerEventStream(samplingPeriod: sensorInterval).listen(
  ...
  _streamSubscriptions.add(
    await accelerometerEventStream(samplingPeriod: sensorInterval).listen(
  ...
  _streamSubscriptions.add(
    await gyroscopeEventStream(samplingPeriod: sensorInterval).listen(
  ...
  _streamSubscriptions.add(
    await magnetometerEventStream(samplingPeriod: sensorInterval).listen(
...
Widget getAccelo(BuildContext context) {
  initState(context);
  _streamSubscriptions.add(
          ...
          children: [
            ...
            TableRow(
              children: [
                const Padding(
                  ...
                  child: Text('UserAccelerometer', textAlign: TextAlign.center),
                ),
                Center(
                    child: Text(
            ...
            TableRow(
              children: [
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0),
                  child: Text('Accelerometer', textAlign: TextAlign.center),
                ),
                Center(
                    child:
